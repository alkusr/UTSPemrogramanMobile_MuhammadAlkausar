...
open class BaseTest {
    ...
    val lastPosition = DataSource.mouses.size - 1

    private fun hasListItemContent(name: String, type: String, con: String, imageResource: Int) {
    ...
    fun checkFirstPosition() {
        hasListItemContent("Tested", "Type: 7", "Con: sunbathing",
            R.drawable.tzeitel)
    }
